...
class GXRabbitMQManager
{
    ...
    /**
     * @var GXRabbitMessage|int|null
     */
    protected $queueMessage = null;

    /**
     * @var string
     */
    protected $connectionType = GXRabbitConnectionType::GLOBAL;
     ...
     * @var array
     */
    protected $payload = [], $deliveries = [];

    /**
     * @var string|null
     */
    protected $senderId = null, $senderType = null;
     ...
     */
    public function __construct($message, $queueMessage = null)
    {
     ...
     */
    public function onConnection($GXRabbitConnection): GXRabbitMQManager
    {
     ...
     * @return GXRabbitMQManager
     */
    public function onSender($sender, $senderType = null): GXRabbitMQManager
    {
